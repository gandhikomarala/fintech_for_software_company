...
/**
 * FinFlow Enterprise — Vendor Master Record, KYC Verification & Bank Tokenization (Service Unit 030)
 ...
 */
public class VendorMasterService_030 {

    private final String serviceIdentifier = "finflow-vendors-unit-030";
