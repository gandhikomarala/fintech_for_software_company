...
/**
 * FinFlow Enterprise — Vendor Master Record, KYC Verification & Bank Tokenization (Service Unit 014)
 ...
 */
public class VendorMasterService_014 {

    private final String serviceIdentifier = "finflow-vendors-unit-014";
