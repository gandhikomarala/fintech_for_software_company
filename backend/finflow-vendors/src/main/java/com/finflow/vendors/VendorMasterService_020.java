...
/**
 * FinFlow Enterprise — Vendor Master Record, KYC Verification & Bank Tokenization (Service Unit 020)
 ...
 */
public class VendorMasterService_020 {

    private final String serviceIdentifier = "finflow-vendors-unit-020";
