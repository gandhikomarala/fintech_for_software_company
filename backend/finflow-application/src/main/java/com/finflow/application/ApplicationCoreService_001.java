...
/**
 * FinFlow Enterprise — Main Spring Boot Application Entrypoint & OpenAPI Controller (Service Unit 001)
 ...
 */
public class ApplicationCoreService_001 {

    private final String serviceIdentifier = "finflow-application-unit-001";
