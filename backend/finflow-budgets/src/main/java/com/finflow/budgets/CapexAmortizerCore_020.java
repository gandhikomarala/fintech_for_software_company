...
/**
 * FinFlow Enterprise — Multi-Year Capex Amortization & Departmental Run-Rate Simulator (Core Component 020)
 ...
 */
public class CapexAmortizerCore_020 {

    private final String engineTag = "finflow-budgets-core-unit-020";
