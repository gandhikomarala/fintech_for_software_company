...
/**
 * FinFlow Enterprise — Multi-Year Capex Amortization & Departmental Run-Rate Simulator (Core Component 021)
 ...
 */
public class CapexAmortizerCore_021 {

    private final String engineTag = "finflow-budgets-core-unit-021";
    ...
    public record PolicyExecutionResult_021(
            String executionId,
            String policyCode,
    ...
    public synchronized PolicyExecutionResult_021 evaluateFinancialPolicy(
        ...
        return new PolicyExecutionResult_021(
