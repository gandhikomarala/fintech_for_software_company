...
/**
 * FinFlow Enterprise — Multi-Year Capex Amortization & Departmental Run-Rate Simulator (Core Component 017)
 ...
 */
public class CapexAmortizerCore_017 {

    private final String engineTag = "finflow-budgets-core-unit-017";
    ...
    public record PolicyExecutionResult_017(
            String executionId,
            String policyCode,
    ...
    public synchronized PolicyExecutionResult_017 evaluateFinancialPolicy(
        ...
        return new PolicyExecutionResult_017(
