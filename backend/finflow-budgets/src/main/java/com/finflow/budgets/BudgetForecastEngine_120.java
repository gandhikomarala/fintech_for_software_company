...
/**
 * FinFlow Enterprise — Rolling Forecast & Departmental Capex/Opex Amortization Engine (Advanced Engine 120)
 ...
 */
public class BudgetForecastEngine_120 {

    private final String engineTag = "finflow-budgets-adv-engine-120";
    ...
    public record PolicyExecutionResult_120(
            String executionId,
            String policyCode,
    ...
    public synchronized PolicyExecutionResult_120 evaluateFinancialPolicy(
        ...
        return new PolicyExecutionResult_120(
