...
/**
 * FinFlow Enterprise — Multi-Year Capex Amortization & Departmental Run-Rate Simulator (Core Component 016)
 ...
 */
public class CapexAmortizerCore_016 {

    private final String engineTag = "finflow-budgets-core-unit-016";
