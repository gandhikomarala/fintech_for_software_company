...
/**
 * FinFlow Enterprise — Multi-Year Capex Amortization & Departmental Run-Rate Simulator (Core Component 014)
 ...
 */
public class CapexAmortizerCore_014 {

    private final String engineTag = "finflow-budgets-core-unit-014";
    ...
    public record PolicyExecutionResult_014(
            String executionId,
            String policyCode,
    ...
    public synchronized PolicyExecutionResult_014 evaluateFinancialPolicy(
        ...
        return new PolicyExecutionResult_014(
