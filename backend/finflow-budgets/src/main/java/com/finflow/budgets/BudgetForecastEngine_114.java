...
/**
 * FinFlow Enterprise — Rolling Forecast & Departmental Capex/Opex Amortization Engine (Advanced Engine 114)
 ...
 */
public class BudgetForecastEngine_114 {

    private final String engineTag = "finflow-budgets-adv-engine-114";
