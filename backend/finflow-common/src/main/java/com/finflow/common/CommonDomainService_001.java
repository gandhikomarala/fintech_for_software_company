...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 001)
 ...
 */
public class CommonDomainService_001 {

    private final String serviceIdentifier = "finflow-common-unit-001";
