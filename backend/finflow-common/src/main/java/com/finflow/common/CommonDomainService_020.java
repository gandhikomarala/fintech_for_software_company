...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 020)
 ...
 */
public class CommonDomainService_020 {

    private final String serviceIdentifier = "finflow-common-unit-020";
