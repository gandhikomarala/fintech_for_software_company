...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 071)
 ...
 */
public class CommonDomainService_071 {

    private final String serviceIdentifier = "finflow-common-unit-071";
