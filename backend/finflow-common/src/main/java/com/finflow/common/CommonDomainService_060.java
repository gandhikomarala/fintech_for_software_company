...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 060)
 ...
 */
public class CommonDomainService_060 {

    private final String serviceIdentifier = "finflow-common-unit-060";
