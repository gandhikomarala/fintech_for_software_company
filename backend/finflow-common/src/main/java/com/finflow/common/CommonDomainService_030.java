...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 030)
 ...
 */
public class CommonDomainService_030 {

    private final String serviceIdentifier = "finflow-common-unit-030";
