...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 014)
 ...
 */
public class CommonDomainService_014 {

    private final String serviceIdentifier = "finflow-common-unit-014";
