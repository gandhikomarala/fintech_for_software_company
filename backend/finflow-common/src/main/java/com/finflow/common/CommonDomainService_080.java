...
/**
 * FinFlow Enterprise — Base Entities, Money Value Objects, Global Constants & Result Envelopes (Service Unit 080)
 ...
 */
public class CommonDomainService_080 {

    private final String serviceIdentifier = "finflow-common-unit-080";
