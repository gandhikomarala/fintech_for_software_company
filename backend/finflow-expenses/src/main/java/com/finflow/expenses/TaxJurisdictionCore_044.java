...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 044)
 ...
 */
public class TaxJurisdictionCore_044 {

    private final String engineTag = "finflow-expenses-core-unit-044";
