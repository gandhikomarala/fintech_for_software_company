...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 018)
 ...
 */
public class TaxJurisdictionCore_018 {

    private final String engineTag = "finflow-expenses-core-unit-018";
