...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 043)
 ...
 */
public class TaxJurisdictionCore_043 {

    private final String engineTag = "finflow-expenses-core-unit-043";
