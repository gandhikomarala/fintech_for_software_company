...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 012)
 ...
 */
public class TaxJurisdictionCore_012 {

    private final String engineTag = "finflow-expenses-core-unit-012";
