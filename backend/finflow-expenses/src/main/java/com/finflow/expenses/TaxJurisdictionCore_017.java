...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 017)
 ...
 */
public class TaxJurisdictionCore_017 {

    private final String engineTag = "finflow-expenses-core-unit-017";
