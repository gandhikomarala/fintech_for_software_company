...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 035)
 ...
 */
public class TaxJurisdictionCore_035 {

    private final String engineTag = "finflow-expenses-core-unit-035";
