...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 011)
 ...
 */
public class TaxJurisdictionCore_011 {

    private final String engineTag = "finflow-expenses-core-unit-011";
