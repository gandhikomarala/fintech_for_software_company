...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 041)
 ...
 */
public class TaxJurisdictionCore_041 {

    private final String engineTag = "finflow-expenses-core-unit-041";
