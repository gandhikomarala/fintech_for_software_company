...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 046)
 ...
 */
public class TaxJurisdictionCore_046 {

    private final String engineTag = "finflow-expenses-core-unit-046";
