...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 003)
 ...
 */
public class TaxJurisdictionCore_003 {

    private final String engineTag = "finflow-expenses-core-unit-003";
