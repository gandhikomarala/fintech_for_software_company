...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 123)
 ...
 */
public class ExpenseForexEngine_123 {

    private final String engineTag = "finflow-expenses-adv-engine-123";
