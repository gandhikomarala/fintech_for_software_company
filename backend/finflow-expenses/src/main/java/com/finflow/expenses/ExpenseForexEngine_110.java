...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 110)
 ...
 */
public class ExpenseForexEngine_110 {

    private final String engineTag = "finflow-expenses-adv-engine-110";
