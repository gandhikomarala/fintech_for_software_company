...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 092)
 ...
 */
public class ExpenseForexEngine_092 {

    private final String engineTag = "finflow-expenses-adv-engine-092";
