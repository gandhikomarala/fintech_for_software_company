...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 087)
 ...
 */
public class ExpenseForexEngine_087 {

    private final String engineTag = "finflow-expenses-adv-engine-087";
