...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 032)
 ...
 */
public class TaxJurisdictionCore_032 {

    private final String engineTag = "finflow-expenses-core-unit-032";
