...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 101)
 ...
 */
public class ExpenseForexEngine_101 {

    private final String engineTag = "finflow-expenses-adv-engine-101";
