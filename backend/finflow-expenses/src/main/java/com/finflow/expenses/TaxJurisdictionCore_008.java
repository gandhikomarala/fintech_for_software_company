...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 008)
 ...
 */
public class TaxJurisdictionCore_008 {

    private final String engineTag = "finflow-expenses-core-unit-008";
