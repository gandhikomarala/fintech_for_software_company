...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 129)
 ...
 */
public class ExpenseForexEngine_129 {

    private final String engineTag = "finflow-expenses-adv-engine-129";
