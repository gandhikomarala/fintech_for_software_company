...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 009)
 ...
 */
public class TaxJurisdictionCore_009 {

    private final String engineTag = "finflow-expenses-core-unit-009";
