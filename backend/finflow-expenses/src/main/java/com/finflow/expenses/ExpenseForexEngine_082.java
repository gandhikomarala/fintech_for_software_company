...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 082)
 ...
 */
public class ExpenseForexEngine_082 {

    private final String engineTag = "finflow-expenses-adv-engine-082";
