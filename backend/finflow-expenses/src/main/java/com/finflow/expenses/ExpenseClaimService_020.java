...
/**
 * FinFlow Enterprise — Multi-Currency Expense Claims & Automated OCR Receipt Processing (Service Unit 020)
 ...
 */
public class ExpenseClaimService_020 {

    private final String serviceIdentifier = "finflow-expenses-unit-020";
