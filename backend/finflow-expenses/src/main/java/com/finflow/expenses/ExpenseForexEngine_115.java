...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 115)
 ...
 */
public class ExpenseForexEngine_115 {

    private final String engineTag = "finflow-expenses-adv-engine-115";
