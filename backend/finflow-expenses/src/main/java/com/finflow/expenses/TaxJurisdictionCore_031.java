...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 031)
 ...
 */
public class TaxJurisdictionCore_031 {

    private final String engineTag = "finflow-expenses-core-unit-031";
