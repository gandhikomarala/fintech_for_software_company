...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 089)
 ...
 */
public class ExpenseForexEngine_089 {

    private final String engineTag = "finflow-expenses-adv-engine-089";
