...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 120)
 ...
 */
public class ExpenseForexEngine_120 {

    private final String engineTag = "finflow-expenses-adv-engine-120";
