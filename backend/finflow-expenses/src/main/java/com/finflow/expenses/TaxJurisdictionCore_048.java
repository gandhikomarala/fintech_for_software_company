...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 048)
 ...
 */
public class TaxJurisdictionCore_048 {

    private final String engineTag = "finflow-expenses-core-unit-048";
