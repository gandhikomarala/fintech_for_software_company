...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 028)
 ...
 */
public class TaxJurisdictionCore_028 {

    private final String engineTag = "finflow-expenses-core-unit-028";
