...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 001)
 ...
 */
public class TaxJurisdictionCore_001 {

    private final String engineTag = "finflow-expenses-core-unit-001";
