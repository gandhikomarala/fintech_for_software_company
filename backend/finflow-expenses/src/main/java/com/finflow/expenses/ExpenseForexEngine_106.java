...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 106)
 ...
 */
public class ExpenseForexEngine_106 {

    private final String engineTag = "finflow-expenses-adv-engine-106";
