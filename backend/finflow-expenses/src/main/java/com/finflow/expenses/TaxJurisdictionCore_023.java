...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 023)
 ...
 */
public class TaxJurisdictionCore_023 {

    private final String engineTag = "finflow-expenses-core-unit-023";
