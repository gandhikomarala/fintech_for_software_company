...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 117)
 ...
 */
public class ExpenseForexEngine_117 {

    private final String engineTag = "finflow-expenses-adv-engine-117";
