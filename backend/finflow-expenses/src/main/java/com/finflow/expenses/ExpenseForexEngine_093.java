...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 093)
 ...
 */
public class ExpenseForexEngine_093 {

    private final String engineTag = "finflow-expenses-adv-engine-093";
