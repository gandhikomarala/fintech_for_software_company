...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 045)
 ...
 */
public class TaxJurisdictionCore_045 {

    private final String engineTag = "finflow-expenses-core-unit-045";
