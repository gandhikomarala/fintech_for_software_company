...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 107)
 ...
 */
public class ExpenseForexEngine_107 {

    private final String engineTag = "finflow-expenses-adv-engine-107";
