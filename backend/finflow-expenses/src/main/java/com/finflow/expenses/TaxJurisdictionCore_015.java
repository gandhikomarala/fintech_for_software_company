...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 015)
 ...
 */
public class TaxJurisdictionCore_015 {

    private final String engineTag = "finflow-expenses-core-unit-015";
