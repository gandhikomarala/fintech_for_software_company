...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 124)
 ...
 */
public class ExpenseForexEngine_124 {

    private final String engineTag = "finflow-expenses-adv-engine-124";
