...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 010)
 ...
 */
public class TaxJurisdictionCore_010 {

    private final String engineTag = "finflow-expenses-core-unit-010";
