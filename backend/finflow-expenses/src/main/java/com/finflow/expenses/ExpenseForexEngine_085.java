...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 085)
 ...
 */
public class ExpenseForexEngine_085 {

    private final String engineTag = "finflow-expenses-adv-engine-085";
