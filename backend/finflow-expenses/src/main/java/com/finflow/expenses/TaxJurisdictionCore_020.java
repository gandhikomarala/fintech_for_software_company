...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 020)
 ...
 */
public class TaxJurisdictionCore_020 {

    private final String engineTag = "finflow-expenses-core-unit-020";
