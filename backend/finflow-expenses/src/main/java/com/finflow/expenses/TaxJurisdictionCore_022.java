...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 022)
 ...
 */
public class TaxJurisdictionCore_022 {

    private final String engineTag = "finflow-expenses-core-unit-022";
