...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 130)
 ...
 */
public class ExpenseForexEngine_130 {

    private final String engineTag = "finflow-expenses-adv-engine-130";
