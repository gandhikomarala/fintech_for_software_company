...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 102)
 ...
 */
public class ExpenseForexEngine_102 {

    private final String engineTag = "finflow-expenses-adv-engine-102";
