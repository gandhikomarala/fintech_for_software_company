...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 094)
 ...
 */
public class ExpenseForexEngine_094 {

    private final String engineTag = "finflow-expenses-adv-engine-094";
