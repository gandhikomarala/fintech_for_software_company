...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 038)
 ...
 */
public class TaxJurisdictionCore_038 {

    private final String engineTag = "finflow-expenses-core-unit-038";
