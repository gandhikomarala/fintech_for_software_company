...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 006)
 ...
 */
public class TaxJurisdictionCore_006 {

    private final String engineTag = "finflow-expenses-core-unit-006";
