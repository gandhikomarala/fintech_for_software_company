...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 090)
 ...
 */
public class ExpenseForexEngine_090 {

    private final String engineTag = "finflow-expenses-adv-engine-090";
