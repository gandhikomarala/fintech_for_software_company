...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 029)
 ...
 */
public class TaxJurisdictionCore_029 {

    private final String engineTag = "finflow-expenses-core-unit-029";
