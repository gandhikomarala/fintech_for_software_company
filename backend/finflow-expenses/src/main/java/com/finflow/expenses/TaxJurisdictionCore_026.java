...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 026)
 ...
 */
public class TaxJurisdictionCore_026 {

    private final String engineTag = "finflow-expenses-core-unit-026";
