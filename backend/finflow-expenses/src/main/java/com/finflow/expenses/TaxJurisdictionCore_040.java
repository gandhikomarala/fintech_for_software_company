...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 040)
 ...
 */
public class TaxJurisdictionCore_040 {

    private final String engineTag = "finflow-expenses-core-unit-040";
