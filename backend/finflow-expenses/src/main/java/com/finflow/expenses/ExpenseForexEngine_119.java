...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 119)
 ...
 */
public class ExpenseForexEngine_119 {

    private final String engineTag = "finflow-expenses-adv-engine-119";
