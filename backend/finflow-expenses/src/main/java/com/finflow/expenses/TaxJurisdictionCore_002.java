...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 002)
 ...
 */
public class TaxJurisdictionCore_002 {

    private final String engineTag = "finflow-expenses-core-unit-002";
