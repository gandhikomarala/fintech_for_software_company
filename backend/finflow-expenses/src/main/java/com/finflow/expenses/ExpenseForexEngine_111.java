...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 111)
 ...
 */
public class ExpenseForexEngine_111 {

    private final String engineTag = "finflow-expenses-adv-engine-111";
