...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 081)
 ...
 */
public class ExpenseForexEngine_081 {

    private final String engineTag = "finflow-expenses-adv-engine-081";
