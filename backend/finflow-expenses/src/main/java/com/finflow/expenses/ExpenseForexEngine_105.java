...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 105)
 ...
 */
public class ExpenseForexEngine_105 {

    private final String engineTag = "finflow-expenses-adv-engine-105";
