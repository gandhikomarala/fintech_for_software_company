...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 112)
 ...
 */
public class ExpenseForexEngine_112 {

    private final String engineTag = "finflow-expenses-adv-engine-112";
