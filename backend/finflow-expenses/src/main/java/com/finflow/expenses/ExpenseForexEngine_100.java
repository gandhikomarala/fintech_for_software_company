...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 100)
 ...
 */
public class ExpenseForexEngine_100 {

    private final String engineTag = "finflow-expenses-adv-engine-100";
