...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 095)
 ...
 */
public class ExpenseForexEngine_095 {

    private final String engineTag = "finflow-expenses-adv-engine-095";
