...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 042)
 ...
 */
public class TaxJurisdictionCore_042 {

    private final String engineTag = "finflow-expenses-core-unit-042";
