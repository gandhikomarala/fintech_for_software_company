...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 088)
 ...
 */
public class ExpenseForexEngine_088 {

    private final String engineTag = "finflow-expenses-adv-engine-088";
