...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 091)
 ...
 */
public class ExpenseForexEngine_091 {

    private final String engineTag = "finflow-expenses-adv-engine-091";
