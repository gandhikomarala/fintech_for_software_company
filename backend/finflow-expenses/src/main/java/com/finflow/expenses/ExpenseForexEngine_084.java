...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 084)
 ...
 */
public class ExpenseForexEngine_084 {

    private final String engineTag = "finflow-expenses-adv-engine-084";
