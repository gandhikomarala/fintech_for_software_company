...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 037)
 ...
 */
public class TaxJurisdictionCore_037 {

    private final String engineTag = "finflow-expenses-core-unit-037";
