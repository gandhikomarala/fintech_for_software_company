...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 007)
 ...
 */
public class TaxJurisdictionCore_007 {

    private final String engineTag = "finflow-expenses-core-unit-007";
