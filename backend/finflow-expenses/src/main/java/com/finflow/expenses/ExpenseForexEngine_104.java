...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 104)
 ...
 */
public class ExpenseForexEngine_104 {

    private final String engineTag = "finflow-expenses-adv-engine-104";
