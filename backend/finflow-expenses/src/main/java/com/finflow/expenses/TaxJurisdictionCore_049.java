...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 049)
 ...
 */
public class TaxJurisdictionCore_049 {

    private final String engineTag = "finflow-expenses-core-unit-049";
