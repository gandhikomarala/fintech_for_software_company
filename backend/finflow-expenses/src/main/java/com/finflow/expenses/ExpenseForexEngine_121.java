...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 121)
 ...
 */
public class ExpenseForexEngine_121 {

    private final String engineTag = "finflow-expenses-adv-engine-121";
