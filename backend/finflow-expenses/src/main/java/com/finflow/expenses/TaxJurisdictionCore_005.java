...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 005)
 ...
 */
public class TaxJurisdictionCore_005 {

    private final String engineTag = "finflow-expenses-core-unit-005";
