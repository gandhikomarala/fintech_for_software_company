...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 014)
 ...
 */
public class TaxJurisdictionCore_014 {

    private final String engineTag = "finflow-expenses-core-unit-014";
