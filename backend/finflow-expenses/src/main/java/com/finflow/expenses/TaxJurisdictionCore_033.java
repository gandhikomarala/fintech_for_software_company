...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 033)
 ...
 */
public class TaxJurisdictionCore_033 {

    private final String engineTag = "finflow-expenses-core-unit-033";
