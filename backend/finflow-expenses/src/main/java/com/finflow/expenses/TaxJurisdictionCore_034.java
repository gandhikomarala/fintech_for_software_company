...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 034)
 ...
 */
public class TaxJurisdictionCore_034 {

    private final String engineTag = "finflow-expenses-core-unit-034";
