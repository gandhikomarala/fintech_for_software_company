...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 118)
 ...
 */
public class ExpenseForexEngine_118 {

    private final String engineTag = "finflow-expenses-adv-engine-118";
