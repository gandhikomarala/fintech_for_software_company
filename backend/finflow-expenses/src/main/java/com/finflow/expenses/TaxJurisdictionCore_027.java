...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 027)
 ...
 */
public class TaxJurisdictionCore_027 {

    private final String engineTag = "finflow-expenses-core-unit-027";
