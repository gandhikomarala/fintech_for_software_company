...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 128)
 ...
 */
public class ExpenseForexEngine_128 {

    private final String engineTag = "finflow-expenses-adv-engine-128";
