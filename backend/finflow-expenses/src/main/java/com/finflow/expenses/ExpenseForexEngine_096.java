...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 096)
 ...
 */
public class ExpenseForexEngine_096 {

    private final String engineTag = "finflow-expenses-adv-engine-096";
