...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 113)
 ...
 */
public class ExpenseForexEngine_113 {

    private final String engineTag = "finflow-expenses-adv-engine-113";
