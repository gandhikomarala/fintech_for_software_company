...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 086)
 ...
 */
public class ExpenseForexEngine_086 {

    private final String engineTag = "finflow-expenses-adv-engine-086";
