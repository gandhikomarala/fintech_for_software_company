...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 097)
 ...
 */
public class ExpenseForexEngine_097 {

    private final String engineTag = "finflow-expenses-adv-engine-097";
