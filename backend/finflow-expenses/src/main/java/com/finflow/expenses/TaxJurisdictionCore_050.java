...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 050)
 ...
 */
public class TaxJurisdictionCore_050 {

    private final String engineTag = "finflow-expenses-core-unit-050";
