...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 098)
 ...
 */
public class ExpenseForexEngine_098 {

    private final String engineTag = "finflow-expenses-adv-engine-098";
