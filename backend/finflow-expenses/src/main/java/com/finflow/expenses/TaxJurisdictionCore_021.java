...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 021)
 ...
 */
public class TaxJurisdictionCore_021 {

    private final String engineTag = "finflow-expenses-core-unit-021";
