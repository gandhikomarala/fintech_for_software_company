...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 036)
 ...
 */
public class TaxJurisdictionCore_036 {

    private final String engineTag = "finflow-expenses-core-unit-036";
