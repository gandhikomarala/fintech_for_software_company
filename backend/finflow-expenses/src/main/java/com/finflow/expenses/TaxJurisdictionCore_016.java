...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 016)
 ...
 */
public class TaxJurisdictionCore_016 {

    private final String engineTag = "finflow-expenses-core-unit-016";
