...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 024)
 ...
 */
public class TaxJurisdictionCore_024 {

    private final String engineTag = "finflow-expenses-core-unit-024";
