...
/**
 * FinFlow Enterprise — Tax Jurisdiction, VAT Settlement & Cross-Border FX Engine (Core Component 019)
 ...
 */
public class TaxJurisdictionCore_019 {

    private final String engineTag = "finflow-expenses-core-unit-019";
