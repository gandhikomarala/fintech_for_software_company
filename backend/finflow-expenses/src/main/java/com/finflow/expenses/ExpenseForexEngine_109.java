...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 109)
 ...
 */
public class ExpenseForexEngine_109 {

    private final String engineTag = "finflow-expenses-adv-engine-109";
