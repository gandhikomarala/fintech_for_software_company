...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 103)
 ...
 */
public class ExpenseForexEngine_103 {

    private final String engineTag = "finflow-expenses-adv-engine-103";
