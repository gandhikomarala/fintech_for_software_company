...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 122)
 ...
 */
public class ExpenseForexEngine_122 {

    private final String engineTag = "finflow-expenses-adv-engine-122";
