...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 125)
 ...
 */
public class ExpenseForexEngine_125 {

    private final String engineTag = "finflow-expenses-adv-engine-125";
