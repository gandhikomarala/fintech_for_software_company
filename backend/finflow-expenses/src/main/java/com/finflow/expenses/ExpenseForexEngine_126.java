...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 126)
 ...
 */
public class ExpenseForexEngine_126 {

    private final String engineTag = "finflow-expenses-adv-engine-126";
