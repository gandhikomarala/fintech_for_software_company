...
/**
 * FinFlow Enterprise — Multi-Currency Forex Rate Arbitrage & Travel Per Diem Policy Engine (Advanced Engine 108)
 ...
 */
public class ExpenseForexEngine_108 {

    private final String engineTag = "finflow-expenses-adv-engine-108";
