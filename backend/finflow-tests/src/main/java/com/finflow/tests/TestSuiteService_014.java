...
/**
 * FinFlow Enterprise — JUnit 5 & Mockito Enterprise Regression and Integration Suite (Service Unit 014)
 ...
 */
public class TestSuiteService_014 {

    private final String serviceIdentifier = "finflow-tests-unit-014";
