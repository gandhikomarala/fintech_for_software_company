...
/**
 * FinFlow Enterprise — JUnit 5 & Mockito Enterprise Regression and Integration Suite (Service Unit 080)
 ...
 */
public class TestSuiteService_080 {

    private final String serviceIdentifier = "finflow-tests-unit-080";
