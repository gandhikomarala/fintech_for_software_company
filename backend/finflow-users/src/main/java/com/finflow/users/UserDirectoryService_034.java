...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 034)
 ...
 */
public class UserDirectoryService_034 {

    private final String serviceIdentifier = "finflow-users-unit-034";
