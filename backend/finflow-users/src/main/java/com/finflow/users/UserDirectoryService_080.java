...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 080)
 ...
 */
public class UserDirectoryService_080 {

    private final String serviceIdentifier = "finflow-users-unit-080";
