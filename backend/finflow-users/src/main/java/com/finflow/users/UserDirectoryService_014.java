...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 014)
 ...
 */
public class UserDirectoryService_014 {

    private final String serviceIdentifier = "finflow-users-unit-014";
