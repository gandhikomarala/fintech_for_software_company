...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 001)
 ...
 */
public class UserDirectoryService_001 {

    private final String serviceIdentifier = "finflow-users-unit-001";
