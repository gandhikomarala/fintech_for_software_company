...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 070)
 ...
 */
public class UserDirectoryService_070 {

    private final String serviceIdentifier = "finflow-users-unit-070";
