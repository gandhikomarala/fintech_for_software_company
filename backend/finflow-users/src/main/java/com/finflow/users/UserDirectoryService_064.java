...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 064)
 ...
 */
public class UserDirectoryService_064 {

    private final String serviceIdentifier = "finflow-users-unit-064";
