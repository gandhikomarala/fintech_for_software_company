...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 020)
 ...
 */
public class UserDirectoryService_020 {

    private final String serviceIdentifier = "finflow-users-unit-020";
