...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 017)
 ...
 */
public class UserDirectoryService_017 {

    private final String serviceIdentifier = "finflow-users-unit-017";
