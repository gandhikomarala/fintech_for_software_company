...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 006)
 ...
 */
public class UserDirectoryService_006 {

    private final String serviceIdentifier = "finflow-users-unit-006";
