...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 063)
 ...
 */
public class UserDirectoryService_063 {

    private final String serviceIdentifier = "finflow-users-unit-063";
