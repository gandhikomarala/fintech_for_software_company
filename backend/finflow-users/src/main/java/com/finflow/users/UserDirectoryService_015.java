...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 015)
 ...
 */
public class UserDirectoryService_015 {

    private final String serviceIdentifier = "finflow-users-unit-015";
