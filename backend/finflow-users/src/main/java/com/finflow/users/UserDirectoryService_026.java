...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 026)
 ...
 */
public class UserDirectoryService_026 {

    private final String serviceIdentifier = "finflow-users-unit-026";
