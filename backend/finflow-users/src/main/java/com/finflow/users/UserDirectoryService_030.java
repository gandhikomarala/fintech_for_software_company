...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 030)
 ...
 */
public class UserDirectoryService_030 {

    private final String serviceIdentifier = "finflow-users-unit-030";
