...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 048)
 ...
 */
public class UserDirectoryService_048 {

    private final String serviceIdentifier = "finflow-users-unit-048";
