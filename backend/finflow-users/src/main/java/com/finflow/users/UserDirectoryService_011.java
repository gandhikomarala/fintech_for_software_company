...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 011)
 ...
 */
public class UserDirectoryService_011 {

    private final String serviceIdentifier = "finflow-users-unit-011";
