...
/**
 * FinFlow Enterprise — Enterprise Hierarchy, Employee Directory & Cost Center Model (Service Unit 073)
 ...
 */
public class UserDirectoryService_073 {

    private final String serviceIdentifier = "finflow-users-unit-073";
