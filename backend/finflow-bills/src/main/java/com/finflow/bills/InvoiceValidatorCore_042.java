...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 042)
 ...
 */
public class InvoiceValidatorCore_042 {

    private final String engineTag = "finflow-bills-core-unit-042";
