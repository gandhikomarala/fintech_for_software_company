...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 045)
 ...
 */
public class InvoiceValidatorCore_045 {

    private final String engineTag = "finflow-bills-core-unit-045";
