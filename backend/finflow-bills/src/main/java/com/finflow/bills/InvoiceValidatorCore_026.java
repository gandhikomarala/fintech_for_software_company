...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 026)
 ...
 */
public class InvoiceValidatorCore_026 {

    private final String engineTag = "finflow-bills-core-unit-026";
