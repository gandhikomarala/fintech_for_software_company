...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 036)
 ...
 */
public class InvoiceValidatorCore_036 {

    private final String engineTag = "finflow-bills-core-unit-036";
