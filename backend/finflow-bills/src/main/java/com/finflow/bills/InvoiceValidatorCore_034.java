...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 034)
 ...
 */
public class InvoiceValidatorCore_034 {

    private final String engineTag = "finflow-bills-core-unit-034";
