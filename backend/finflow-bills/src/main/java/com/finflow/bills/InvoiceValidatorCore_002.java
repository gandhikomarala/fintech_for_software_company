...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 002)
 ...
 */
public class InvoiceValidatorCore_002 {

    private final String engineTag = "finflow-bills-core-unit-002";
