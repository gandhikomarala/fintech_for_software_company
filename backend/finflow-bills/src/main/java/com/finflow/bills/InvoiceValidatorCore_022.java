...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 022)
 ...
 */
public class InvoiceValidatorCore_022 {

    private final String engineTag = "finflow-bills-core-unit-022";
