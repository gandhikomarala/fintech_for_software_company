...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 011)
 ...
 */
public class InvoiceValidatorCore_011 {

    private final String engineTag = "finflow-bills-core-unit-011";
