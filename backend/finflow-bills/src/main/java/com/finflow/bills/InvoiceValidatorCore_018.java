...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 018)
 ...
 */
public class InvoiceValidatorCore_018 {

    private final String engineTag = "finflow-bills-core-unit-018";
