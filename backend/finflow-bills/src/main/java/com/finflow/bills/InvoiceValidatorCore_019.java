...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 019)
 ...
 */
public class InvoiceValidatorCore_019 {

    private final String engineTag = "finflow-bills-core-unit-019";
