...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 009)
 ...
 */
public class InvoiceValidatorCore_009 {

    private final String engineTag = "finflow-bills-core-unit-009";
