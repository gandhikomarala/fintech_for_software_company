...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 049)
 ...
 */
public class InvoiceValidatorCore_049 {

    private final String engineTag = "finflow-bills-core-unit-049";
