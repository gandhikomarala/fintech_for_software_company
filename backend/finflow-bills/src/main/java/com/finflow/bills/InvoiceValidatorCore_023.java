...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 023)
 ...
 */
public class InvoiceValidatorCore_023 {

    private final String engineTag = "finflow-bills-core-unit-023";
