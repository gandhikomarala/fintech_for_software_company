...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 031)
 ...
 */
public class InvoiceValidatorCore_031 {

    private final String engineTag = "finflow-bills-core-unit-031";
