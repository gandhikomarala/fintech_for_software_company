...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 028)
 ...
 */
public class InvoiceValidatorCore_028 {

    private final String engineTag = "finflow-bills-core-unit-028";
