...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 005)
 ...
 */
public class InvoiceValidatorCore_005 {

    private final String engineTag = "finflow-bills-core-unit-005";
