...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 037)
 ...
 */
public class InvoiceValidatorCore_037 {

    private final String engineTag = "finflow-bills-core-unit-037";
