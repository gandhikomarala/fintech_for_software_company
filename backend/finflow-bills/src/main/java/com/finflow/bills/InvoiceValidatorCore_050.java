...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 050)
 ...
 */
public class InvoiceValidatorCore_050 {

    private final String engineTag = "finflow-bills-core-unit-050";
