...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 014)
 ...
 */
public class InvoiceValidatorCore_014 {

    private final String engineTag = "finflow-bills-core-unit-014";
