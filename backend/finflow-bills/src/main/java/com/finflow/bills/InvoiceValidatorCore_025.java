...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 025)
 ...
 */
public class InvoiceValidatorCore_025 {

    private final String engineTag = "finflow-bills-core-unit-025";
