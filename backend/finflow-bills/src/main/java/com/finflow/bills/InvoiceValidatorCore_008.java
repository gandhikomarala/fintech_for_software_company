...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 008)
 ...
 */
public class InvoiceValidatorCore_008 {

    private final String engineTag = "finflow-bills-core-unit-008";
