...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 047)
 ...
 */
public class InvoiceValidatorCore_047 {

    private final String engineTag = "finflow-bills-core-unit-047";
