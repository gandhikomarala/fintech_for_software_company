...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 020)
 ...
 */
public class InvoiceValidatorCore_020 {

    private final String engineTag = "finflow-bills-core-unit-020";
