...
/**
 * FinFlow Enterprise — Automated OCR Two-Way Matching & Purchase Order Reconciler (Advanced Engine 087)
 ...
 */
public class BillReconcilerEngine_087 {

    private final String engineTag = "finflow-bills-adv-engine-087";
