...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 003)
 ...
 */
public class InvoiceValidatorCore_003 {

    private final String engineTag = "finflow-bills-core-unit-003";
