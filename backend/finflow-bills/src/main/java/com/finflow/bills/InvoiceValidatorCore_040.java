...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 040)
 ...
 */
public class InvoiceValidatorCore_040 {

    private final String engineTag = "finflow-bills-core-unit-040";
