...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 038)
 ...
 */
public class InvoiceValidatorCore_038 {

    private final String engineTag = "finflow-bills-core-unit-038";
