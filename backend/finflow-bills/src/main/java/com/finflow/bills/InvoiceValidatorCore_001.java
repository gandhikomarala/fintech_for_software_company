...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 001)
 ...
 */
public class InvoiceValidatorCore_001 {

    private final String engineTag = "finflow-bills-core-unit-001";
