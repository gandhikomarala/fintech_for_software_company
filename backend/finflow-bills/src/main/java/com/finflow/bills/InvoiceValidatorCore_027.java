...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 027)
 ...
 */
public class InvoiceValidatorCore_027 {

    private final String engineTag = "finflow-bills-core-unit-027";
