...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 044)
 ...
 */
public class InvoiceValidatorCore_044 {

    private final String engineTag = "finflow-bills-core-unit-044";
