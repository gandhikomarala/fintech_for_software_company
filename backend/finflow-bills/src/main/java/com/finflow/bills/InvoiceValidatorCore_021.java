...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 021)
 ...
 */
public class InvoiceValidatorCore_021 {

    private final String engineTag = "finflow-bills-core-unit-021";
