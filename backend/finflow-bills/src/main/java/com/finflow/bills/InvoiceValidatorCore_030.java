...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 030)
 ...
 */
public class InvoiceValidatorCore_030 {

    private final String engineTag = "finflow-bills-core-unit-030";
