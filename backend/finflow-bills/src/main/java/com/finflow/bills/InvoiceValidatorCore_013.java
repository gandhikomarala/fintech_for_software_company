...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 013)
 ...
 */
public class InvoiceValidatorCore_013 {

    private final String engineTag = "finflow-bills-core-unit-013";
