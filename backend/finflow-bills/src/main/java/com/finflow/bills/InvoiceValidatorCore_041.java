...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 041)
 ...
 */
public class InvoiceValidatorCore_041 {

    private final String engineTag = "finflow-bills-core-unit-041";
