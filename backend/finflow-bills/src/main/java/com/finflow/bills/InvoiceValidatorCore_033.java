...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 033)
 ...
 */
public class InvoiceValidatorCore_033 {

    private final String engineTag = "finflow-bills-core-unit-033";
