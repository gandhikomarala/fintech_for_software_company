...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 012)
 ...
 */
public class InvoiceValidatorCore_012 {

    private final String engineTag = "finflow-bills-core-unit-012";
