...
/**
 * FinFlow Enterprise — Automated OCR Two-Way Matching & Purchase Order Reconciler (Advanced Engine 100)
 ...
 */
public class BillReconcilerEngine_100 {

    private final String engineTag = "finflow-bills-adv-engine-100";
