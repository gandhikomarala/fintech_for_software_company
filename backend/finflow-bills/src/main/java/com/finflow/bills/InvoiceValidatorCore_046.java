...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 046)
 ...
 */
public class InvoiceValidatorCore_046 {

    private final String engineTag = "finflow-bills-core-unit-046";
