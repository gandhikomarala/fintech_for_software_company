...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 032)
 ...
 */
public class InvoiceValidatorCore_032 {

    private final String engineTag = "finflow-bills-core-unit-032";
