...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 010)
 ...
 */
public class InvoiceValidatorCore_010 {

    private final String engineTag = "finflow-bills-core-unit-010";
