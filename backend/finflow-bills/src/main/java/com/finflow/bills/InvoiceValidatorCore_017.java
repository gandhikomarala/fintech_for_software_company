...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 017)
 ...
 */
public class InvoiceValidatorCore_017 {

    private final String engineTag = "finflow-bills-core-unit-017";
