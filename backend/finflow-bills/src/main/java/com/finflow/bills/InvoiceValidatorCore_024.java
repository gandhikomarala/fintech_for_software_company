...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 024)
 ...
 */
public class InvoiceValidatorCore_024 {

    private final String engineTag = "finflow-bills-core-unit-024";
