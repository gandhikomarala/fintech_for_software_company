...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 048)
 ...
 */
public class InvoiceValidatorCore_048 {

    private final String engineTag = "finflow-bills-core-unit-048";
