...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 039)
 ...
 */
public class InvoiceValidatorCore_039 {

    private final String engineTag = "finflow-bills-core-unit-039";
