...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 015)
 ...
 */
public class InvoiceValidatorCore_015 {

    private final String engineTag = "finflow-bills-core-unit-015";
