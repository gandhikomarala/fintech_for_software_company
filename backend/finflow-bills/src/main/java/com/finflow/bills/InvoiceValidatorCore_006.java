...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 006)
 ...
 */
public class InvoiceValidatorCore_006 {

    private final String engineTag = "finflow-bills-core-unit-006";
