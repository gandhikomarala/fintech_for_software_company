...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 007)
 ...
 */
public class InvoiceValidatorCore_007 {

    private final String engineTag = "finflow-bills-core-unit-007";
