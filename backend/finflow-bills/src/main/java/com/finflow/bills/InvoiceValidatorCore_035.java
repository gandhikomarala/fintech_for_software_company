...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 035)
 ...
 */
public class InvoiceValidatorCore_035 {

    private final String engineTag = "finflow-bills-core-unit-035";
