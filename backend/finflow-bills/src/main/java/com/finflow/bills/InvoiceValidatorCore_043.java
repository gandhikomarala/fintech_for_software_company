...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 043)
 ...
 */
public class InvoiceValidatorCore_043 {

    private final String engineTag = "finflow-bills-core-unit-043";
