...
/**
 * FinFlow Enterprise — Enterprise OCR 3-Way Line Matching & Purchase Order Validator (Core Component 004)
 ...
 */
public class InvoiceValidatorCore_004 {

    private final String engineTag = "finflow-bills-core-unit-004";
