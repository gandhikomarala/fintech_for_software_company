...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 017)
 ...
 */
public class StatutoryLedgerCore_017 {

    private final String engineTag = "finflow-reporting-core-unit-017";
