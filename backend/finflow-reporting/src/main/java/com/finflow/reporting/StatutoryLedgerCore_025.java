...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 025)
 ...
 */
public class StatutoryLedgerCore_025 {

    private final String engineTag = "finflow-reporting-core-unit-025";
