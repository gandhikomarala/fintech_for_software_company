...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 001)
 ...
 */
public class StatutoryLedgerCore_001 {

    private final String engineTag = "finflow-reporting-core-unit-001";
