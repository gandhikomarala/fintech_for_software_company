...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 035)
 ...
 */
public class StatutoryLedgerCore_035 {

    private final String engineTag = "finflow-reporting-core-unit-035";
