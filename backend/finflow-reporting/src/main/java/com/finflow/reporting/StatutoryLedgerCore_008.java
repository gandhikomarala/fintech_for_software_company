...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 008)
 ...
 */
public class StatutoryLedgerCore_008 {

    private final String engineTag = "finflow-reporting-core-unit-008";
