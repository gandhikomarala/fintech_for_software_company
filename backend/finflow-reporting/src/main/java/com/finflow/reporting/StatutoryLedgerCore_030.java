...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 030)
 ...
 */
public class StatutoryLedgerCore_030 {

    private final String engineTag = "finflow-reporting-core-unit-030";
