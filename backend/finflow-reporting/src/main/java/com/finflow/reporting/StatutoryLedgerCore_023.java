...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 023)
 ...
 */
public class StatutoryLedgerCore_023 {

    private final String engineTag = "finflow-reporting-core-unit-023";
