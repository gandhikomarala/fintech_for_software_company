...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 027)
 ...
 */
public class StatutoryLedgerCore_027 {

    private final String engineTag = "finflow-reporting-core-unit-027";
