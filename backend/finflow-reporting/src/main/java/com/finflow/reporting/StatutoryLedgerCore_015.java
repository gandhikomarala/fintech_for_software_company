...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 015)
 ...
 */
public class StatutoryLedgerCore_015 {

    private final String engineTag = "finflow-reporting-core-unit-015";
