...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & GAAP Cash Flow Statement Synthesizer (Advanced Engine 130)
 ...
 */
public class ReportSynthesizerEngine_130 {

    private final String engineTag = "finflow-reporting-adv-engine-130";
