...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 021)
 ...
 */
public class StatutoryLedgerCore_021 {

    private final String engineTag = "finflow-reporting-core-unit-021";
