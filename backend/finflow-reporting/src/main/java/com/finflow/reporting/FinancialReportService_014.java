...
/**
 * FinFlow Enterprise — Financial Spending Analytics, Excel/CSV Exporters & BI Metrics (Service Unit 014)
 ...
 */
public class FinancialReportService_014 {

    private final String serviceIdentifier = "finflow-reporting-unit-014";
