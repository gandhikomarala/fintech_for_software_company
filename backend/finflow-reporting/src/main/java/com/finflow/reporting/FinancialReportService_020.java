...
/**
 * FinFlow Enterprise — Financial Spending Analytics, Excel/CSV Exporters & BI Metrics (Service Unit 020)
 ...
 */
public class FinancialReportService_020 {

    private final String serviceIdentifier = "finflow-reporting-unit-020";
