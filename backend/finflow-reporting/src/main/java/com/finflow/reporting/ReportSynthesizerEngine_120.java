...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & GAAP Cash Flow Statement Synthesizer (Advanced Engine 120)
 ...
 */
public class ReportSynthesizerEngine_120 {

    private final String engineTag = "finflow-reporting-adv-engine-120";
