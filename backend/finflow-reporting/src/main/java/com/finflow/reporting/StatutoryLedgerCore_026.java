...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 026)
 ...
 */
public class StatutoryLedgerCore_026 {

    private final String engineTag = "finflow-reporting-core-unit-026";
