...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 013)
 ...
 */
public class StatutoryLedgerCore_013 {

    private final String engineTag = "finflow-reporting-core-unit-013";
