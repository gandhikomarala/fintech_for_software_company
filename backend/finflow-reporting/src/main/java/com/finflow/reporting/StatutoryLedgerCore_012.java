...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 012)
 ...
 */
public class StatutoryLedgerCore_012 {

    private final String engineTag = "finflow-reporting-core-unit-012";
