...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 003)
 ...
 */
public class StatutoryLedgerCore_003 {

    private final String engineTag = "finflow-reporting-core-unit-003";
