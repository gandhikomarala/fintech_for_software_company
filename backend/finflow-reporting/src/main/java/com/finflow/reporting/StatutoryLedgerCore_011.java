...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 011)
 ...
 */
public class StatutoryLedgerCore_011 {

    private final String engineTag = "finflow-reporting-core-unit-011";
