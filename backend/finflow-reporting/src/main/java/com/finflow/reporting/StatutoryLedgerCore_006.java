...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 006)
 ...
 */
public class StatutoryLedgerCore_006 {

    private final String engineTag = "finflow-reporting-core-unit-006";
