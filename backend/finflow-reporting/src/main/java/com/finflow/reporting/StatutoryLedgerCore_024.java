...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 024)
 ...
 */
public class StatutoryLedgerCore_024 {

    private final String engineTag = "finflow-reporting-core-unit-024";
