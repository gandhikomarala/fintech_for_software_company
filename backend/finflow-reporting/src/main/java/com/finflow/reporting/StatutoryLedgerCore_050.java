...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 050)
 ...
 */
public class StatutoryLedgerCore_050 {

    private final String engineTag = "finflow-reporting-core-unit-050";
