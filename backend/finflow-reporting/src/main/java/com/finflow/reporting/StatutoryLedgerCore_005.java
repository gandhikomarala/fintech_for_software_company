...
/**
 * FinFlow Enterprise — Consolidated Balance Sheet & Statutory Tax Ledger Synthesizer (Core Component 005)
 ...
 */
public class StatutoryLedgerCore_005 {

    private final String engineTag = "finflow-reporting-core-unit-005";
